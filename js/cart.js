document.addEventListener("DOMContentLoaded", () => {
  ...
  function prepareWrapperDivForCartItems(product, productQuantityMapping){
    ...
    document.querySelector('#orderDetails').appendChild(orderDetailsProduct);
    document.querySelector('#orderDetails').appendChild(hr);
  ...
  async function populateCart(){
    ...
    document.querySelector('#net-price').textContent = `$${totalPrice-10}`;
    removeLoader();
  }
populateCart();
});